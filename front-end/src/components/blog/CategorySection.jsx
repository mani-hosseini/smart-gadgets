...
const CategoryCard = ({category}) => (
    <div className="relative h-32 rounded-lg overflow-hidden cursor-pointer group">
        ...
        <div className="absolute top-2 left-2">
            <div
                className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white text-xs font-bold">
                {category.count}
            </div>
        </div>
...
const CategoryCardMobile = ({category}) => (
    <div className="relative h-24 rounded-lg overflow-hidden cursor-pointer group">
        ...
        <div className="absolute top-1 left-1">
            <div
                className="w-5 h-5 bg-blue-600 rounded-full flex items-center justify-center text-white text-xs font-bold">
                {category.count}
            </div>
        </div>
