...
export default function BlogPost() {
    ...
    return (
        <div className="container mx-auto py-8 px-2 sm:px-0">
            <div className="w-full overflow-x-auto whitespace-nowrap">
                <BreadcrumbBox pageName={<span><Link to="/blog" className="text-blue-700 font-bold">وبلاگ</Link> / {post.title}</span>} />
            </div>
            <div className="bg-[#f7f7f7] rounded-3xl p-6 flex flex-col-reverse md:flex-row-reverse gap-8 items-center">
                <div className="md:w-1/2 w-full flex flex-col justify-center">
                    ...
                    <div className="flex justify-between bg-white rounded-xl md:py-4 py-2 mt-8">
                        {prev ? (
                            <Link to={prev.link}
